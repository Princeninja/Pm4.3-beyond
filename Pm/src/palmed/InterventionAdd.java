...
public class InterventionAdd {
	...
	public static boolean add( Rec ptRec, Component parent ) {
		...
		new InterventionAdd( EditPt.Operation.NEWPT, ptRec, null, parent );
		return true;
	}
	...
	public static boolean edit( Rec ptRec, Reca parReca, Component parent ) {
		...
		new InterventionAdd( EditPt.Operation.EDITPT, ptRec, parReca, parent );
		return true;
	}
	 ...
	 * methods.
	 */
	private InterventionAdd( EditPt.Operation operation, Rec ptRec, Reca parReca, Component parent ) {
		super();
	...
	private void createBox( EditPt.Operation operation, Rec ptRec, Reca parReca, Component parent ) {
		...
		// create new window
		Window win = (Window) Executions.createComponents( "intervadd.zul", parent, myMap );
		try {
			win.doModal();
		} catch (Exception e) {
