...
public class ERViewWinController extends GenericForwardComposer {
	
	private Rec	ptRec = null;

	
	// Display fields at top of chart (ALL AUTOWIRED)
	private Window ERViewWin;		// autowired
	...
	public void doAfterCompose( Component component ){
		...
		ERViewWin.setTitle( dirPt.getName().getPrintableNameLFM());
		...
		// log the access
		AuditLogger.recordEntry( AuditLog.Action.ER_PORTAL, ptRec, Pm.getUserRec(), null, "IP: " + Executions.getCurrent().getRemoteAddr() );
	...
	public void onClick$btnCCR(){
		PtCCR.exportCCRtoProvider( ptRec );
	}
