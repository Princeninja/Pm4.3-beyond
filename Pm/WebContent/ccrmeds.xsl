...
<!-- Adapted from AAFP's CCR XSLT stylesheet
	This one has been stripped down to show the header and medication information only - used for medication reconciliation.
	J. Richard Palen, MD
	September 2011
-->
...
--&gt;</style>
  ...
  <xsl:template name="footer">
	...
	The stylesheet used to generate this view of the CCR was adapted from the AAFP and the CCR Acceleration Task Force's sample CCR XSLT stylesheet.
</font>
          </th>
        </tr>
        <tr>
